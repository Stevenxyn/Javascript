...
2;
array1.splice(pos, 2)["mandarina"][("pera", "manzana")]; // posision de inicio 2 = mandarina, segundo parameteo se cuenta normal 1 2 3 hasta donde queremos eliminar
array1.push("mandarina2");

array1.splice(pos, 1)["mandarina2"]; // pos tiene la posicion del elemento del array con splice se elimina si se tiene la posicion exacta
